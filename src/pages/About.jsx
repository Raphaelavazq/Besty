      ...
      <div className="max-w-6xl mx-auto p-6 space-y-8">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-6 lg:p-8">
          ...
          <p className="text-slate-700 leading-relaxed text-lg">
            B1 Bestie ist ein moderner Content Hub zur Vorbereitung auf die DTZ
            (Deutsch-Test für Zuwanderer) B1 Prüfung. Hier findest du gut
            strukturierte Lerninhalte, Übungen und praktische Tipps für alle
            vier Prüfungsteile: Hören, Lesen, Schreiben und Sprechen.
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-slate-600">
              Diese Vorteile helfen dir bei deiner Prüfungsvorbereitung
            </p>
          </div>
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-slate-600">
              Alle Bereiche der DTZ B1 Prüfung im Überblick
            </p>
          </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-3xl p-8 text-white shadow-2xl max-w-2xl mx-auto">
            ...
            <p className="text-purple-100 mb-6">
              Mit B1 Bestie bist du bestens vorbereitet
            </p>
