  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-pink-50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-16">
        {/* Tab Navigation */}
        <div className="bg-white/60 backdrop-blur-xl rounded-2xl p-2 shadow-xl border border-white/40 mb-8 sm:mb-12">
        ...
        <div className="space-y-6">
          ...
          {activeTab === "start" && (
            <div className="space-y-6 animate-fadeIn">
              {/* What is it */}
              <div className="bg-white/60 backdrop-blur-xl rounded-3xl p-6 sm:p-10 shadow-2xl border border-white/40">
          ...
          {activeTab === "format" && (
            <div className="space-y-6 animate-fadeIn">
              <div className="bg-white/60 backdrop-blur-xl rounded-3xl p-6 sm:p-10 shadow-2xl border border-white/40">
                ...
                <div className="space-y-6">
                  {/* Formal */}
                  <div className="bg-gradient-to-br from-indigo-50/60 to-purple-50/60 backdrop-blur-sm rounded-2xl p-6 border border-indigo-200/40">
                  ...
                  {/* Informal */}
                  <div className="bg-gradient-to-br from-purple-50/60 to-pink-50/60 backdrop-blur-sm rounded-2xl p-6 border border-purple-200/40">
            ...
            <div className="space-y-6 animate-fadeIn">
              <div className="bg-white/60 backdrop-blur-xl rounded-3xl p-6 sm:p-10 shadow-2xl border border-white/40">
                ...
                <div className="space-y-4">
                  ...
                  {/* Tip 2 */}
                  <div className="bg-gradient-to-br from-indigo-100/60 to-purple-100/60 backdrop-blur-sm rounded-2xl p-6 border border-indigo-200/40">
                    <div className="flex gap-4">
                      <div className="flex-shrink-0">
